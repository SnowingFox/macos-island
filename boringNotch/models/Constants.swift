...
extension Defaults.Keys {
    ...
    // MARK: Liquid Glass
    static let useLiquidGlass = Key<Bool>("useLiquidGlass", default: false)

    // MARK: Market Ticker
    static let enableMarketTicker = Key<Bool>("enableMarketTicker", default: false)

    // MARK: Pomodoro
    static let enablePomodoro = Key<Bool>("enablePomodoro", default: false)
